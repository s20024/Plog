...
interface IconBusinessCardProps {
  width?: number;
  height?: number;
  fill?: string;
}

const IconBusinessCard: React.FC<IconBusinessCardProps> = ({ width = 24, height = 24, fill = 'currentColor' }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 640 640" fill={fill}>
